            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-10">
                    <div class="row align-items-center my-4">
                        <div class="col">
                            <hr class="my-4">
                            <h2 class="h3 mb-0 page-title">Add New Patient Employee</h2>
                        </div>
                        <div class="col-auto">

                        </div>
                    </div>
                    <form action="/save_new_medical_history_college" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control input-placeholder" id="custom-placeholder" type="text"
                                    name="birthday">
                            </div>
                            <div class="form-group col-md-4">
