...
<html lang="en">
    ...
    <body class="vertical  light  ">
        <div class="wrapper">
            {{-- topbar --}}
            <nav class="topnav navbar navbar-light" style="background: #D2334C">
                <button type="button" class="navbar-toggler text-muted mt-2 p-0 mr-3 collapseSidebar">
                    <i class="fe fe-menu navbar-toggler-icon" style="color: white"></i>
                </button>
                <div class="mr-auto d-flex align-items-center">
                    <img src="{{ asset('pics/uic-logo-small.png') }}" alt="" width="50px" class="mr-3">
                    <h1 class="my-0" style="color: white; margin-left: 10px; font-size: 28px;">UIC CLINIC</h1>
                </div>
            </nav>
                ...
                <nav class="vertnav navbar navbar-light">
                    ...
                    <ul class="navbar-nav flex-fill w-100 mb-2">
                        <li class="nav-item dropdown">
                            <a href="{{ url('/dashboard') }}" class=" nav-link ml-3 item-text">Dashboard</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav flex-fill w-100 mb-2">
                        ...
                        <a class="nav-link pl-3" href="{{ route('college') }}"><span class="ml-1 item-text">College</span>
                        </a>
                        <a class="nav-link pl-3" href="{{ route('basicedu') }}"><span class="ml-1 item-text">Basic
                                Education</span>
                        </a>
                        <a class="nav-link pl-3" href="{{ route('clinic_employee') }}"><span class="ml-1 item-text">Employee</span>
                </a>
                    </ul>
                    ...
                    <div class="btn-box w-100 mt-4 mb-1">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button class="btn mb-2 btn-primary btn-lg btn-block" type="submit"
                                style="background-color:#D2334C; border:#D2334C">Logout</button>
                        </form>
                        </a>
                    </div>
                </nav>
